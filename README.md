...
- Separation of agent roles: Planner (declarative) vs Executor (imperative) vs Orchestrator (coordination)
- Hybrid AI/rules: LLM via Ollama with a deterministic fallback; ensures reliability
- Streaming UX: NDJSON is simple and Postman/curl friendly; easy to switch to WebSockets later
- Testability: Planner is pure; services are mockable; API contract via Pydantic
- Replaceability: swap weather/LLM providers without touching Planner/Orchestrator

## License

For demo/assignment purposes.
